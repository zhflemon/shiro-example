...
public class ClientDaoImpl implements ClientDao {
	...
	public Client updateClient(Client client) {
		...
		jdbcTemplate.update(sql, client.getClientName(), client.getClientId(), client.getClientSecret(),
				client.getId());
		return client;
	}
	...
	public Client findOne(Long clientId) {
		...
		List<Client> clientList = jdbcTemplate.query(sql, new BeanPropertyRowMapper<Client>(Client.class), clientId);
